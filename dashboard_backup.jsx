...
const Dashboard = () => {
    ...
    const challenges = [
        { id: 1, title: 'ÔÜí Desafio Rel├ómpago', task: 'Fa├ºa 20 agachamentos agora!', reward: 50 },
        { id: 2, title: '­ƒöÑ Queima R├ípida', task: 'Corra 1km sem parar!', reward: 100 },
        { id: 3, title: '­ƒÆ¬ For├ºa Total', task: 'Fa├ºa 15 flex├Áes perfeitas!', reward: 75 },
        { id: 4, title: '­ƒºÿ Equil├¡brio', task: 'Prancha por 60 segundos!', reward: 60 },
        { id: 5, title: '­ƒÅâ Sprint Challenge', task: 'Burpees x 10 repeti├º├Áes!', reward: 80 }
    ];

    const tips = [
        'Beber 500ml de ├ígua logo ao acordar acelera o metabolismo.',
        'Descanso ├® t├úo importante quanto treino. Durma 7-8h por noite.',
        'Prote├¡nas p├│s-treino ajudam na recupera├º├úo muscular.',
    ...
    const saveHydrationGoal = async () => {
        ...
        try {
            ...
            alert('Erro ao salvar meta de hidrata├º├úo. Tente novamente.');
        }
    };
    ...
    return (
        <div className="min-h-screen pb-32 pt-8 px-6 bg-gray-50 dark:bg-gray-950 font-sans transition-colors duration-300">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                {/* Meta Di├íria (Orange) - Click to Edit Goal */}
                <div
                ...
                {/* Hidrata├º├úo (Blue) - Click to Edit Goal, FAB to Add */}
                <div
                ...
                >
                    <div className="flex justify-between items-start">
                        <span className="bg-white/20 backdrop-blur-md px-3 py-1 rounded-full text-xs font-bold">Hidrata├º├úo</span>
                ...
                {/* Desafio Rel├ómpago (Challenge Card) */}
                <div className="col-span-2 bg-gradient-to-r from-purple-600 to-pink-600 rounded-[2.5rem] p-6 text-white shadow-[0_20px_50px_rgba(168,85,247,0.5)] relative overflow-hidden h-52 flex flex-col justify-between">
                    ...
                    {challengeCompleted ? (
                        <div className="relative z-10 bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full font-black text-sm text-center">
                            Ô£à Conclu├¡do! Volte amanh├ú ­ƒöÑ
                        </div>
                    ) : (
                        <button
                ...
                >
                    <div className="flex items-start justify-between">
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <h3 className="text-white font-bold text-lg">MISS├òES</h3>
                        </div>
                    ...
                    <p className="text-slate-300 text-sm mb-3">
                        Complete miss├Áes di├írias para ganhar XP extra!
                    </p>
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-[2rem] p-6 w-full max-w-sm shadow-2xl">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 font-medium">Beba ├ígua e bata a meta.</p>
                            </div>
                            <div className="flex items-center gap-4">
            ...
            {showGoalModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white dark:bg-gray-900 rounded-[2rem] p-6 w-full max-w-sm shadow-2xl">
                        <h3 className="text-xl font-black text-gray-900 dark:text-white mb-4">Meta de Hidrata├º├úo</h3>
                        <div className="mb-6">
                            <label className="block text-sm font-bold text-gray-500 mb-2">Meta Di├íria (ml)</label>
                            <input
                                type="number"
                                value={hydrationGoal}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-white dark:bg-gray-900 rounded-[2rem] p-6 w-full max-w-sm shadow-2xl animate-in fade-in zoom-in duration-200">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="text-xl font-black text-gray-900 dark:text-white">Adicionar ├ügua</h3>
